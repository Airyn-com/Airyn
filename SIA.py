...
def laporan():
    ...
    with app.app_context():
        ...
        laporan_content += """
            ...
            <!-- TAB BARU: LAPORAN ARUS KAS -->
<div id="laporan-arus-kas" class="tab-content">
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Laporan Arus Kas - Metode Langsung</h2>
            <p style="color: #64748b; margin: 0;">Periode: """ + date.today().strftime("%d %B %Y") + """</p>
        </div>
        ...
        <div class="laporan-keuangan-container">
            <div class="laporan-section">
                ...
                <div class="laporan-body">
                    <h4 style="color: #374151; margin-bottom: 1rem; border-bottom: 2px solid #e5e7eb; padding-bottom: 0.5rem;">
                        ARUS KAS DARI AKTIVITAS OPERASI
                    </h4>
                    
                    <div class="laporan-row">
                        <span>Kas diterima dari pelanggan:</span>
                        <span class="laporan-positive">Rp """ + f"{arus_kas_data['kas_diterima_pelanggan']:,.0f}" + """</span>
                    </div>
                    
                    <div style="margin: 1rem 0; padding-left: 1rem; border-left: 3px solid #e5e7eb;">
                        <div class="laporan-row">
                            <span style="margin-left: 1rem;">Kas dibayarkan untuk:</span>
                            <span></span>
                        </div>
                        <div class="laporan-row">
                            <span style="margin-left: 2rem;">- Pembelian persediaan</span>
                            <span class="laporan-negative">(Rp """ + f"{arus_kas_data['kas_keluar_pembelian']:,.0f}" + """)</span>
                        </div>
                        <div class="laporan-row">
                            <span style="margin-left: 2rem;">- Beban operasional</span>
                            <span class="laporan-negative">(Rp """ + f"{arus_kas_data['kas_keluar_beban']:,.0f}" + """)</span>
                        </div>
                        """ + (f"""
                        <div class="laporan-row">
                            <span style="margin-left: 2rem;">- Pembelian perlengkapan</span>
                            <span class="laporan-negative">(Rp {arus_kas_data['kas_keluar_perlengkapan']:,.0f})</span>
                        </div>
                        """ if arus_kas_data['kas_keluar_perlengkapan'] > 0 else "") + """
                        """ + (f"""
                        <div class="laporan-row">
                            <span style="margin-left: 2rem;">- Pengeluaran lainnya</span>
                            <span class="laporan-negative">(Rp {arus_kas_data['kas_keluar_lainnya']:,.0f})</span>
                        </div>
                        """ if arus_kas_data['kas_keluar_lainnya'] > 0 else "") + """
                    </div>
                    
                    <div class="laporan-row laporan-total">
                        <span>Kas Bersih dari Aktivitas Operasi:</span>
                        <span class="laporan-positive">Rp """ + f"{arus_kas_data['kas_bersih_operasi']:,.0f}" + """</span>
                    </div>
                    
                    <h4 style="color: #374151; margin: 1.5rem 0 0.5rem 0; border-bottom: 2px solid #e5e7eb; padding-bottom: 0.5rem;">
                        ARUS KAS DARI AKTIVITAS INVESTASI
                    </h4>
                    <div class="laporan-row">
                        <span>Pembelian/perolehan aset tetap:</span>
                        <span class="laporan-negative">(Rp """ + f"{arus_kas_data['kas_investasi']:,.0f}" + """)</span>
                    </div>
                    ...
                    <div class="laporan-row">
                        <span>Penerimaan dari pemilik/pinjaman:</span>
                        <span class="laporan-positive">Rp """ + f"{arus_kas_data['kas_pendanaan']:,.0f}" + """</span>
                    </div>
                    
                    <div class="laporan-row laporan-total" style="border-top: 2px solid #374151; margin-top: 1rem;">
                    ...
                    <div class="laporan-row">
                        ...
                        <span>Rp """ + f"{arus_kas_data['saldo_kas_awal']:,.0f}" + """</span>
                    </div>
                    
                    <div class="laporan-row laporan-total">
                        <span>Saldo Kas Akhir Periode:</span>
                        <span class="laporan-positive">Rp """ + f"{arus_kas_data['saldo_kas_akhir']:,.0f}" + """</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="background: #f0f9ff; padding: 1rem; border-radius: 8px; margin-top: 1rem; border-left: 4px solid #0ea5e9;">
            <h4 style="color: #0369a1; margin: 0 0 0.5rem 0;">💡 Informasi Laporan Arus Kas</h4>
            <p style="color: #0369a1; margin: 0; font-size: 0.9rem;">
                <strong>Metode Langsung</strong> - Menunjukkan penerimaan dan pengeluaran kas aktual dari aktivitas operasi, investasi, dan pendanaan.
                Laporan ini terintegrasi otomatis dengan semua transaksi kas sistem.
            </p>
        </div>
    </div>
</div>
